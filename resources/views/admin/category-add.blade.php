...
<body>
<div class="pd-20">
  <form action="/admin/add-classify" method="post" class="form form-horizontal" id="form-user-add">
  {{ csrf_field() }}
    <div class="row cl">
...
@if (session('act_msg'))
    <div class="Huialert Huialert-success" style="margin-top: 10px;"><i class="Hui-iconfont">&#xe6a6;</i>{{ session('act_msg') }}</div>
@endif
</div>
<!--_footer 作为公共模版分离出去--> 
